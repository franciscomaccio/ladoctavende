...
const CATEGORIES = ['Almacén', 'Casa/Construcción', 'Deportes', 'Educación', 'Estética', 'Gastronomía', 'Inmobiliaria', 'Librería/Regalería', 'Mascotas', 'Moda', 'Otros', 'Salud', 'Servicios', 'Tecnología', 'Vehículos'];
