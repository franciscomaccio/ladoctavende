...
const CATEGORIES = ['Almacén/Súper', 'Casa/Construcción', 'Deportes', 'Educación', 'Estética', 'Gastronomía', 'Inmobiliaria', 'Librería/Regalería', 'Mascotas', 'Moda', 'Otros', 'Salud', 'Servicios', 'Tecnología', 'Vehículos'];
